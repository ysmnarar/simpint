...
class CategoryController extends Controller
{
    ...
    public function addCategory(Request $request){
        ...
        return redirect()->route('admin.index.category')->with('Create', "Data $request->category Successfully Added");
    }
    ...
    public function updateCategory(Request $request, Category $category){
        ...
        ->with('Update', "Data $request->category Successfully Update");
    }
    ...
    public function deleteCategory(Request $request){
        ...
        $categories->category = $request->category;
        $categories->delete();
        return redirect()->back()->with('Delete', "Data $request->category Successfully Delete");
    }
